...
class TestPDFExtractor(unittest.TestCase):
    ...
    def _create_single_column_pdf_with_references(self, num_refs: int = 20) -> str:
        ...
        story.append(Paragraph("This is a sample paper for testing reference extraction.", styles['Normal']))
    ...
    def _create_two_column_pdf_with_references(self, num_refs: int = 55) -> str:
        ...
        frame1 = Frame(
            ...
            doc.width / 2 - 6, doc.height,
            id='col1'
        )
        frame2 = Frame(
            doc.leftMargin + doc.width / 2 + 6, doc.bottomMargin,
            doc.width / 2 - 6, doc.height,
            id='col2'
        )
    ...
    def _create_pdf_with_figures_and_references(self) -> str:
        ...
        story.append(Paragraph("Analysis of the data shows interesting patterns.", styles['Normal']))
        story.append(Spacer(1, 0.1 * inch))
