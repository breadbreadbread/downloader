...
class TestHTTPClient(unittest.TestCase):
    ...
    def test_403_retry_with_header_rotation(self):
        ...
        with patch('requests.Session.get') as mock_get:
            ...
            mock_response_403.raise_for_status.side_effect = HTTPError(response=mock_response_403)
    ...
    def test_retry_on_503_error(self):
        ...
        with patch('requests.Session.get') as mock_get:
            ...
            mock_response_503.raise_for_status.side_effect = HTTPError(response=mock_response_503)
